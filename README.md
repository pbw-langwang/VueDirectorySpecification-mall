...
5. 网络相关的封装可以看devPhone4(比后者更为详细)和devPhone3

## 注意
1. a.txt文件是为了能上传到github才创建的,里面是介绍文件夹应该放什么东西
2. **一定要注意,不要随便透露接口,老师说了,如果再崩溃就不再给接口了,老师的接口收费的,我直接在这里给大家用,没有收费,所以也请大家不要随意恶搞**
